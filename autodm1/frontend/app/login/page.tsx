        ...
        <div className="relative z-10">
          ...
          <div className="mt-32 space-y-6 max-w-md">
            <h1 className="text-5xl font-bold leading-tight italic">
              Automate your <br />
              <span className="text-brand">engagement</span> like a pro.
            </h1>
      ...
      <div className="flex items-center justify-center p-8 bg-white">
        ...
        >
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-accent italic">Welcome Back</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="email" placeholder="tejas@example.com" className="input pl-10" />
                </div>
              </div>

              <div className="space-y-2">
                <div className="flex justify-between items-center ml-1">
                  <label className="text-xs font-bold text-accent uppercase tracking-wider">Password</label>
                  <button className="text-xs font-bold text-brand hover:underline">Forgot password?</button>
                </div>
                <div className="relative">
            ...
            <button className="btn-primary w-full py-4 mt-4 font-bold text-lg">
              Sign In
            </button>

            <p className="text-center text-sm text-gray-400 pt-4">
              Don't have an account? <Link href="/signup" className="text-accent font-bold hover:underline italic">Create for free</Link>
            </p>
          </div>
        </motion.div>
      </div>
