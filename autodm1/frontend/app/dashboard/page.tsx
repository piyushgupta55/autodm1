    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-slideIn">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Welcome back, Tejas! Here's what's happening today.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <h2 className="text-xl font-bold text-accent">Quick Insights</h2>
          ...
          <div className="card">
            <h4 className="font-bold text-accent mb-4">Account Health</h4>
            <div className="space-y-4">
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-500">IG Connection</span>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-accent font-medium">842 / 1000</span>
              </div>
              <div className="w-full bg-gray-100 h-2 rounded-full overflow-hidden">
